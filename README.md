...
[![Category: Networking](https://img.shields.io/badge/Category-Networking-purple)](#)

| Field | Value |
| --- | --- |
| **Name** | `vps-ssh-proxy-bypass-skill` |
...
cp -r networking/vps-ssh-proxy-bypass ~/.hermes/skills/networking/vps-ssh-proxy-bypass/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/vps-ssh-proxy-bypass-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/vps-ssh-proxy-bypass-skill.git ~/.hermes/skills/networking/vps-ssh-proxy-bypass/
```
...
```text
skill_view(name="networking/vps-ssh-proxy-bypass")
```
...
```text
Use the vps ssh proxy bypass skill to <describe your specific task here>
```
...
```text
Gunakan skill vps ssh proxy bypass untuk <deskripsikan tugas spesifik Anda di sini>
```
